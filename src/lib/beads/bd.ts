...
import { doltSync, type SyncMode, type SyncOutcome } from "./sync-coalescer";
...
// a pass runs; this module owns talking to bd, including the pass itself (runDoltSync). Re-exported
// here so bd.ts stays the single import site for beads state.
