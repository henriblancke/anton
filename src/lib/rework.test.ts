...
// end-to-end cases that drive them through `reworkTicket`. The request contract, the note strings
// and the target vetting are pure enough to test without any of this file's fakes, so they have
// their own suites: rework-contract.test.ts, rework-notes.test.ts, rework-target.test.ts.
const {
  assertRetireStood,
  planRework,
  resolvePipeline,
