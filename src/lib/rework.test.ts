...
// Every step `reworkTicket` composes has its own suite, driven without this file's fakes:
// rework-contract.test.ts, rework-notes.test.ts, rework-target.test.ts, rework-pipeline.test.ts and
// rework-modes.test.ts. What is left here is the send-back end to end.
