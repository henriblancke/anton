...
// The two modes, imported directly: each is unit-tested below on its own, beside the end-to-end
// cases that drive them through `reworkTicket`. Every other step has its own suite, asserted
// without this file's fakes: rework-contract.test.ts, rework-notes.test.ts, rework-target.test.ts
// and rework-pipeline.test.ts.
