/**
 * The warm-outcome migration (drizzle/0056, anton-de17i), asserted against the database that could
...
const MIGRATION = "0056_run_warm_outcome.sql";
...
describe("drizzle/0056 — runs gain a warm outcome", () => {
