/**
 * The warm-outcome migration (drizzle/0057, anton-de17i), asserted against the database that could
...
const MIGRATION = "0057_run_warm_outcome.sql";
...
/** An anton.db at 0053, with a run that predates the warm columns. */
beforeEach(() => {
...
describe("drizzle/0057 — runs gain a warm outcome", () => {
