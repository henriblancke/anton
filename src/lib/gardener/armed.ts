 ...
 * (beads/dolt-sync.ts `runDoltSync`), and Dolt merges a concurrent write to a DIFFERENT column of
 ...
 * one: auth, an unreachable remote, a real divergence (beads/dolt-sync.ts `runDoltSync`). So a
