 ...
 *
 * Three properties the settings panel cannot prove on its own. The signature is the SERVER's — who
 ...
 * armed at all, at the route as well as in the resolver. And revoking removes the signature ALONE,
 * leaving the operator's chosen level in place for the earned floor to answer again.
 */
