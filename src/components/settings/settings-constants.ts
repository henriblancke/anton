...
// Mirrors DEFAULT_COMMIT_TIMEOUT_MINUTES / COMMIT_TIMEOUT_MINUTES_RANGE (src/lib/projects.ts).
export const DEFAULT_COMMIT_TIMEOUT_MINUTES = 2;
export const COMMIT_TIMEOUT_MINUTES_MIN = 1;
export const COMMIT_TIMEOUT_MINUTES_MAX = 60;
// Mirrors DEFAULT_PUSH_TIMEOUT_MINUTES / PUSH_TIMEOUT_MINUTES_RANGE (src/lib/projects.ts).
export const DEFAULT_PUSH_TIMEOUT_MINUTES = 2;
export const PUSH_TIMEOUT_MINUTES_MIN = 1;
export const PUSH_TIMEOUT_MINUTES_MAX = 60;
