...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    "dist/**",
    // graft's Claude Code shims — CommonJS, generated by `graft init`, and rewritten in place
    // whenever the installed graft outruns the stamp in graft/.cache. Linting them fails on
    // `require()` and any fix would be reverted by the next session's self-heal.
    ".claude/helpers/*.cjs",
  ]),
  {
    files: ["src/**/*.{ts,tsx}"],
